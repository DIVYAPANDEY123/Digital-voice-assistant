        ...
        if "on" in query:
            ...
            while True:
                ...
                if "wikipedia" in query:
                    ...
                    speak('Viewers please Subscribe to KARTIS Youtube channel, So that you can also get me in your Desktop through the source code which is available in our Telegram Channel!')
                    speak('And don\'t forget to hit the Like Button ')
